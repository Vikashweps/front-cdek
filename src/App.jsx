...
function App() {
  ...
  const faqData = [
    { question: "Как долго длится игра?", answer: "Обычно игра длится 2-3 недели от момента регистрации до обмена подарками." },
    { question: "Что будет, если участник не заполнил вишлист?", answer: "Мы рекомендуем заполнить вишлист, чтобы ваш Тайный Санта знал, что вам подарить." },
    { question: "Когда я узнаю, кому дарить подарок?", answer: "Вы узнаете получателя после жеребьёвки в назначенную дату." },
    { question: "Могу ли я вытянуть самого себя?", answer: "Нет, система автоматически исключает возможность вытянуть себя." }
  ];
